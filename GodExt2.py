...
class Simulation():
    ...
    def _GetIndexOfNeighbourWithFood(self, Row, Column):
        for Index in self.__GetIndicesOfNeighbours(Row, Column):
            if Index != -1:
        ...
        for Count in range(1, NumberOfStages + 1):
            ...
            for A in self._Ants:
                ...
                if A.GetFoodCarried() > 0 and A.IsAtOwnNest():
                    ...
                    A.ChooseCellToMoveTo(self.__GetIndicesOfNeighbours(A.GetRow(), A.GetColumn()), self.__GetIndexOfNeighbourWithStrongestPheromone(A.GetRow(), A.GetColumn()), self.__GetIndexOfNeighbourWithFood(A.GetRow(), A.GetColumn()))
            for N in self._Nests:
...
class Ant(Entity):
    ...
    def ChooseCellToMoveTo(self, ListOfNeighbours, IndexOfNeighbourWithStrongestPheromone, IndexOfNeighbourWithFood):
        pass
    ...
    def ChooseCellToMoveTo(self, ListOfNeighbours, IndexOfNeighbourWithStrongestPheromone, IndexOfNeighbourWithFood):
        if self._AmountOfFoodCarried > 0:
            ...
            if self._Column > self._NestColumn:
                ...
                self._Column += 1
        elif IndexOfNeighbourWithFood != -1: 
            IndexToUse = ListOfNeighbours.index(IndexOfNeighbourWithFood)
